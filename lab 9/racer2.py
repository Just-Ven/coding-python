...
bg = pygame.image.load("lab 8\src\AnimatedStreet.png") # фон игры

# фоновая музыка
pygame.mixer.music.load("lab 8/src/background.wav")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('lab 8\src\goldcoin.png')
...
class Treasure(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab 8/src/treasure.png")
